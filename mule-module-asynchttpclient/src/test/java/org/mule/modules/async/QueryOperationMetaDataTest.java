...
import org.mule.modules.async.connectivity.MockXmlConnectorConnectionManager;
import org.mule.modules.async.processors.QueryMessageProcessor;
import org.mule.modules.async.processors.QuerySingleMessageProcessor;
...
public class QueryOperationMetaDataTest
{
    ...
    {
        HttClientConnector pojoConnector = new HttClientConnector();
