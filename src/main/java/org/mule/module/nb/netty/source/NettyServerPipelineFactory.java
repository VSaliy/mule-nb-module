...
public class NettyServerPipelineFactory implements ChannelPipelineFactory
{
    ...
    public NettyServerPipelineFactory(NBMessageProcessor nbMessageProcessor, MuleEventFactory muleEventFactory)
    {
    ...
    public ChannelPipeline getPipeline() throws Exception
    {
        ...
        pipeline.addLast("handler", new NettyServerHandler(muleEventFactory,nbMessageProcessor));
        return pipeline;
    }
}