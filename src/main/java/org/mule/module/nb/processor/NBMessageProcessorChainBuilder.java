...
public class NBMessageProcessorChainBuilder extends AbstractMessageProcessorChainBuilder
{


    public NBMessageProcessorChainBuilder(FlowConstruct flowConstruct)
    {
    ...
    {
        return new NBMessageProcessorChain("Non Blocking Chain of " + name,
